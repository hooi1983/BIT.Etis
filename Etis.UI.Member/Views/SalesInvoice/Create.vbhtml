...
@Using Html.BeginForm("Create", Me.ViewData.Item("Controller").ToString, Nothing, FormMethod.Post, New With {.id = "frmCreate", .class = "form-horizontal", .role = "form"})
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="MemberPartnerID" class="col-md-4 control-label">Pembeli <span class="required">*</span></label>
                        <div class="col-md-8">
                            @Html.BuyerPartnerDdl(MemberID:=Model.MemberID, ObjectClass:="form-control")
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            @Html.TransactionTypeDdl(ShowDefault:=True, ObjectClass:="form-control")
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Detail Transaksi</label>
                        <div class="col-md-8">
                            @Html.TransactionTypeSubDdl(ObjectClass:="form-control")
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row text-right">
                        <div class="col-md-5 col-md-offset-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    (+<span id="VatTotalAmount">0.00</span>)
                                </div>
                            </div>
                            <div class="row">
